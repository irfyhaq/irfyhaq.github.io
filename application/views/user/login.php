      ...
      <div class="container">
         <div class="login-page">
            <div class="form">
               ...
               <?php } ?>
               <form method="post" accept-charset="utf-8" action="<?php echo base_url();?>user/login" class="login-form">
                  <input type="text" name="username" placeholder="username"/>
                  <input type="password" name="pass" placeholder="password"/>
                  <button type="submit">login</button>
                  <p class="message">Not registered? <a href="<?php echo base_url();?>user/register">Create an account</a></p>
               </form>
            </div>
         </div>
      </div>
